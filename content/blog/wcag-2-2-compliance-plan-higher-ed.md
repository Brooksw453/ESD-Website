---
title: How to Build a WCAG 2.2 Compliance Plan for Higher Ed
slug: wcag-2-2-compliance-plan-higher-ed
description: A WCAG 2.2 compliance plan for higher education, step by step — scope, ownership, priorities, budget, and timeline an ADA coordinator can actually defend.
date: 2026-05-19
author: Brooks Winchell
excerpt: Most institutions don't have a WCAG 2.2 accessibility problem. They have a planning problem. Here's the plan an ADA coordinator can actually defend in a budget meeting.
---
...
1. **How many people hit this, and can they route around it?** The registration flow, the LMS login, the financial aid form — these have no workaround.
2. **What's the harm if it fails?** A student who can't register has a different problem than a slightly awkward heading order on the alumni page.
